...
CREATE TABLE IF NOT EXISTS `cities` (
  ...
  PRIMARY KEY (`id`),
  KEY `id_estado` (`state_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=523 ;

INSERT INTO `cities` (`id`, `state_id`, `name`, `capital`) VALUES
(1, 1, 'Maroa', 0),
...
INSERT INTO `estados` (`id`, `name`, `iso_3166-2`, `country_id`) VALUES
(1, 'Amazonas', 'VE-X', 237),
(2, 'Anzoátegui', 'VE-B', 237),
(3, 'Apure', 'VE-C', 237),
(4, 'Aragua', 'VE-D', 237),
(5, 'Barinas', 'VE-E', 237),
(6, 'Bolívar', 'VE-F', 237),
...
(14, 'Miranda', 'VE-M', 237),
(15, 'Monagas', 'VE-N', 237),
(16, 'Nueva Esparta', 'VE-O', 237),
(17, 'Portuguesa', 'VE-P', 237),
(18, 'Sucre', 'VE-R', 237),
(19, 'Táchira', 'VE-S', 237),
(20, 'Trujillo', 'VE-T', 237),
(21, 'La Guaira', 'VE-W', 237),
(22, 'Yaracuy', 'VE-U', 237),
(23, 'Zulia', 'VE-V', 237),
(24, 'Distrito Capital', 'VE-A', 237),
(25, 'Dependencias Federales', 'VE-Z', 237);
...
INSERT INTO `municipios` (`id`, `state_id`, `municipio`) VALUES
(1, 1, 'Alto Orinoco'),
(2, 1, 'Atabapo'),
(3, 1, 'Atures'),
(4, 1, 'Autana'),
