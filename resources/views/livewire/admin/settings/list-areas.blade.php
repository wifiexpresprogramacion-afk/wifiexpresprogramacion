<div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="d-flex justify-content-between mb-2">
                        <button wire:click.prevent="addNew" class="btn btn-primary"><i class="fa fa-plus-circle mr-1"></i> Nueva Area</button>
                            ...
                            <table class="table table-hover table-bordered table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Comercios Registrados</th>
                                ...
                                <tbody wire:loading.class="text-muted">
                                    ...
                                    <tr>
                                        <th scope="row">{{ $areas->firstItem() + $index }}</th>
                                        <td>
                                            {{ $area->name }}
                                        </td>
                                        <td>{{ $area->CantComercio() }}</td>
                                        <td>{{ $area->created_at ?? 'N/A' }}</td>
                                        <td>
                                            
                                            <a href="" wire:click.prevent="edit({{ $area }})">
                                                <i class="fa fa-edit mr-2"></i>
                                            </a>

                                            <a href="" wire:click.prevent="confirmAreaRemoval({{ $area->id }})">
    ...
    <div class="modal fade" id="form" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <form autocomplete="off" wire:submit.prevent="{{ $showEditModal ? 'updateArea' : 'createArea' }}">
    ...
    <div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Esta usted seguro de querer eliminar esta area?</h4>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal"><i class="fa fa-times mr-1"></i> Cancelar</button>
                    <button type="button" wire:click.prevent="deleteArea" class="btn btn-danger"><i class="fa fa-trash mr-1"></i>Eliminar Area</button>
                </div>
            </div>
        </div>
    </div>
